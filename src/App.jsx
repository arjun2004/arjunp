...
function App() {
  return (
    <>
      ...
      <div className="px-4 py-5 my-5 text-center container-fluid cf">
        <img
        ...
        <div className="col-lg-6 mx-auto">
          <p className="lead mb-4">
            My name is <b>Arjun.P</b> and I'm a CS(AI) student in
            MBCET,Trivandrum,Kerala.
            <br /> Welcome to my part of internet!{" "}
          </p>
          <div className="d-grid gap-2 d-sm-flex justify-content-sm-center">
            <a
              href="https://github.com/arjun2004"
              className="btn btn-lg btn-light fw-bold border-white bg-white rounded-pill"
            >
              <AiFillGithub />
              &nbsp;Github
            </a>
